...
<project>
  ...
  <dependencies>
    <dependency>
      ...
      <version>2.7.0.v20151009-1723</version>
    </dependency>
    <dependency>
      <groupId>org.eclipse.mylyn.docs</groupId>
      <artifactId>org.eclipse.mylyn.wikitext.core</artifactId>
      <version>2.7.0.v20151015-1452</version>
    </dependency>
    <dependency>
      <groupId>org.eclipse.mylyn.docs</groupId>
...
A major difference is also that link:http://jmini.github.io/blog/2016/2016-02-21_maven_repo_and_pom_files.html[the dependencies declaration is not the same between the Eclipse Fundation repository and my repository].
